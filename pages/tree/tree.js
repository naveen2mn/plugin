$(function () {
	...
	function render(){
		...
		model.forEach(function(e,ind){
			//console.log(e)
			html += '<div class="list-group"><a class="list-item">'+e.name+'</a><div class="hide">'
			e.child.forEach(function(el,index){
				html += '<div class="list-group-item"><a class="list-item">'+el.name+'</a><div class="hide">'
				el.child.forEach(function(ele){
					html += '<div class=""><a class="list-item">'+ele.name+'</a></div>';
				})
				html += '</div></div>'
			})
			html += '</div></div>'
